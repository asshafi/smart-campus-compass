  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText('sc4ff4ce' /* Notifications */),
                  ...
                  child: Material(
                    ...
                    child: SwitchListTile.adaptive(
                      ...
                      title: Text(
                        FFLocalizations.of(
                          context,
                        ).getText('gjygkr0n' /* Push Notifications */),
                        style: FlutterFlowTheme.of(context).headlineSmall
                            .override(fontFamily: 'Lexend', letterSpacing: 0.0),
                      ),
                      subtitle: Text(
                        FFLocalizations.of(context).getText(
                ...
                Material(
                  ...
                  child: SwitchListTile.adaptive(
                    ...
                    title: Text(
                      FFLocalizations.of(
                        context,
                      ).getText('1ytebj35' /* Email Notifications */),
                      style: FlutterFlowTheme.of(context).headlineSmall
                          .override(fontFamily: 'Lexend', letterSpacing: 0.0),
                    ),
                    subtitle: Text(
                ...
                Material(
                  ...
                  child: SwitchListTile.adaptive(
                    ...
                    title: Text(
                      FFLocalizations.of(
                        context,
                      ).getText('69d2j74u' /* Location Services */),
                      style: FlutterFlowTheme.of(context).headlineSmall
                          .override(fontFamily: 'Lexend', letterSpacing: 0.0),
                    ),
                    subtitle: Text(
